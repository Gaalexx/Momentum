...
sealed class NavRoutes : NavKey {
    ...
    @Serializable data object RegistrationCode : NavRoutes()
    @Serializable data object RegistrationPassword : NavRoutes()

    //Экраны входа
    @Serializable data object AuthorizationLogin : NavRoutes()
    @Serializable data object AuthorizationCode : NavRoutes()
    @Serializable data object AuthorizationPassword : NavRoutes()
    @Serializable data object AuthorizationPasswordRecovery : NavRoutes()
